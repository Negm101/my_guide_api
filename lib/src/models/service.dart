...
class SerRedAttributes {
    ...
    factory SerRedAttributes.fromJson(Map<String, dynamic> json) => SerRedAttributes(
        title: json["Title"],
...
class ServDataAttributes {
    ...
    factory ServDataAttributes.fromJson(Map<String, dynamic> json) => ServDataAttributes(
        name: json["name"],
...
class ServLocalizations {
    ...
    factory ServLocalizations.fromJson(Map<String, dynamic> json) => ServLocalizations(
        data: List<ServLocalizationsDatum>.from(json["data"].map((x) => ServLocalizationsDatum.fromJson(x))),
    );
...
class ServLocalizationsDatum {
    ...
    factory ServLocalizationsDatum.fromJson(Map<String, dynamic> json) => ServLocalizationsDatum(
        id: json["id"],
...
class ServFluffyAttributes {
    ...
    factory ServFluffyAttributes.fromJson(Map<String, dynamic> json) => ServFluffyAttributes(
        title: json["Title"],
        createdAt: DateTime.parse(json["createdAt"]),
        updatedAt: DateTime.parse(json["updatedAt"]),
        publishedAt: DateTime.parse(json["publishedAt"]),
...
class ServUniversities {
    ...
    factory ServUniversities.fromJson(Map<String, dynamic> json) => ServUniversities(
        data: List<ServUniversitiesDatum>.from(json["data"].map((x) => ServUniversitiesDatum.fromJson(x))),
    );
...
class ServUniversitiesDatum {
    ...
    factory ServUniversitiesDatum.fromJson(Map<String, dynamic> json) => ServUniversitiesDatum(
        id: json["id"],
...
class ServTentacledAttributes {
    ...
    factory ServTentacledAttributes.fromJson(Map<String, dynamic> json) => ServTentacledAttributes(
        name: json["Name"],
        description: json["Description"],
        createdAt: DateTime.parse(json["createdAt"]),
        updatedAt: DateTime.parse(json["updatedAt"]),
